...
`.github/workflows/ci.yml` を新規追加し、3ランナーで実行して**全7ジョブが緑**になった（run 31666626824、コミット `e524981` = 現在の HEAD）。steps.md のステップ1〜11 が完了し、ステップ12 の機械確認と、PR 本文・Issue #10・PR #11 への記録も済んでいる。
